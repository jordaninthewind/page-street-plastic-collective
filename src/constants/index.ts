...
const PAGE_STREET_BOUNDS: [[number, number], [number, number]] = [
  [-122.45370156687358, 37.77011360610052],
  [-122.42083449962726, 37.77429666244831],
];

export const COVER_STATES: Record<string, { color: string }> = {
...
export const PAGE_STREET_HIGHLIGHT_SOURCE: GeoJSONSourceSpecification = {
  type: "geojson",
  data: {
    type: "Feature",
    geometry: {
...
export const PAGE_STREET_HIGHLIGHT_LAYER: LineLayerSpecification = {
  id: "page-street-line",
  type: "line",
