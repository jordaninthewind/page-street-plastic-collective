  ...
  <Section id="solution">
    <Grid container spacing={4}>
      ...
      <Grid item size={{ xs: 12 }}>
        <Typography variant="h4">We have designed and are actively printing a cheap 3D printed version of the sewer cover to let anyone print their own and cover up theirs or their neighbor's sewer cover.</Typography>
      </Grid>
    </Grid>
  </Section>
);
