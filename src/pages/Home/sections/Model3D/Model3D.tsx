...
import { GradientButton, InfoBlock, Section } from "@app/components";
    ...
    <Section {...MODEL_3D_SECTION}>
      ...
      >
        <Stack direction="column" spacing={2}>
          ...
          <a
            href={import.meta.env.VITE_3D_MODEL_URL as string}
            download
      ...
      <InfoBlock>Download and print the model to help cover your drain!</InfoBlock>
    </Section>
  );
};
